...
assertSolanaIrysWriteEnabled('Solana/Irys script write surface: core-cm-v2/mainnet-deploy.mjs');
...
async function main() {
  ...
  console.log('\n1. Creating Core Collection...');
  // Use previously uploaded collection image
  const firstAsset = uploaded['1'];
  await createCollectionV1(umi, {
    collection: collectionMint,
    name: 'Burned-Out Agents',
    uri: firstAsset.metadataUri, // Reuse BOA #1 metadata as collection metadata
