...
import { SATP_MAINNET_REGISTRATION_PROGRAM_ID } from "./satp-mainnet-programs";
...
export const SOLANA_RPC = `${process.env.NEXT_PUBLIC_API_URL || "https://agentfolio.bot"}/solana-rpc`;
