...
export default async function DocsPage() {
  ...
  const endpoints = [
    ...
    { method: "POST", path: "/api/verify/agentmail/start", desc: "Retired AgentMail trust verification", body: '{ "profileId", "email" }', returns: "410 retired non-verifying profile link" },
    { method: "POST", path: "/api/verify/agentmail/confirm", desc: "Retired AgentMail trust verification", body: '{ "profileId", "code" }', returns: "410 retired non-verifying profile link" },
    { method: "POST", path: "/api/verify/telegram/initiate", desc: "Retired Telegram trust verification", body: '{ "profileId" }', returns: "410 retired non-verifying profile link" },
    { method: "POST", path: "/api/verify/telegram/confirm", desc: "Retired Telegram trust verification", body: '{ "challengeId", "chatId" }', returns: "410 retired non-verifying profile link" },
    ...
    { method: "GET", path: "/api/v3/escrow/health", desc: "Escrow live-funds gate status", body: null, returns: "{ liveEscrow, sdkAvailable, network }" },
    { method: "POST", path: "/api/v3/escrow/create", desc: "Build identity-gated escrow transaction when live-funds gate is enabled", body: '{ "clientWallet", "agentWallet", "amountLamports", "description", "deadlineUnix" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/submit-work", desc: "Build submit-work transaction when live-funds gate is enabled", body: '{ "escrowPDA", "workProof", "agentWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/release", desc: "Build release transaction when live-funds gate is enabled", body: '{ "escrowPDA", "agentWallet", "clientWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/partial-release", desc: "Build milestone release transaction when live-funds gate is enabled", body: '{ "escrowPDA", "agentWallet", "amountLamports", "clientWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/cancel", desc: "Build cancel transaction when live-funds gate is enabled", body: '{ "escrowPDA", "clientWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/dispute", desc: "Build dispute transaction when live-funds gate is enabled", body: '{ "escrowPDA", "reason", "signerWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/resolve", desc: "Build dispute resolution transaction when live-funds gate is enabled", body: '{ "escrowPDA", "agentAmountLamports", "clientAmountLamports", ... }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/close", desc: "Build close transaction when live-funds gate is enabled", body: '{ "escrowPDA", "clientWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
    { method: "POST", path: "/api/v3/escrow/extend-deadline", desc: "Build deadline extension transaction when live-funds gate is enabled", body: '{ "escrowPDA", "newDeadline", "clientWallet" }', returns: "423 read-only gate until security re-review clears live funds" },
