...
export default async function DocsPage() {
  ...
  const endpoints = [
    ...
    { method: "POST", path: "/api/verify/solana/challenge", desc: "Start Solana wallet verification", body: '{ "profileId": "...", "walletAddress": "..." }', returns: "challengeId + message to sign" },
    { method: "POST", path: "/api/verify/solana/confirm", desc: "Confirm Solana wallet signature", body: '{ "challengeId", "signature" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/x/initiate", desc: "Start X tweet challenge", body: '{ "profileId", "xHandle" }', returns: "challengeId + code to tweet" },
    { method: "POST", path: "/api/verify/x/confirm", desc: "Confirm X tweet", body: '{ "challengeId", "tweetUrl" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/github/initiate", desc: "Start GitHub gist challenge", body: '{ "profileId", "username" }', returns: "challengeId + gist content" },
    { method: "POST", path: "/api/verify/github/confirm", desc: "Confirm GitHub gist", body: '{ "challengeId", "gistUrl" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/eth/initiate", desc: "Start Ethereum wallet verification", body: '{ "profileId", "address|walletAddress" }', returns: "challengeId + EIP-191 message" },
    { method: "POST", path: "/api/verify/eth/verify", desc: "Confirm Ethereum signature", body: '{ "challengeId", "signature" }', returns: "Verification result" },
    { method: "POST", path: "/api/profile/{profileId}/verify/hyperliquid/initiate", desc: "Start Hyperliquid verification", body: '{ "address|walletAddress" }', returns: "challengeId + signable message" },
    { method: "POST", path: "/api/profile/{profileId}/verify/hyperliquid/complete", desc: "Complete Hyperliquid verification", body: '{ "challengeId", "signature" }', returns: "Verification result" },
    ...
    { method: "POST", path: "/api/verify/agentmail/confirm", desc: "Confirm AgentMail code", body: '{ "challengeId|profileId", "code" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/telegram/initiate", desc: "Start Telegram verification", body: '{ "profileId", "telegramUsername?" }', returns: "challengeId + bot instructions" },
    { method: "POST", path: "/api/verify/telegram/verify", desc: "Confirm Telegram", body: '{ "challengeId" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/moltbook/initiate", desc: "Start Moltbook verification", body: '{ "profileId", "username|moltbookUsername" }', returns: "Bio challenge string" },
    { method: "POST", path: "/api/verify/mcp/initiate", desc: "Verify an MCP endpoint", body: '{ "profileId", "serverUrl|mcpUrl" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/a2a/initiate", desc: "Verify an A2A agent card", body: '{ "profileId", "agentUrl" }', returns: "Verification result" },
    { method: "POST", path: "/api/verify/discord/initiate", desc: "Start Discord verification", body: '{ "profileId", "discordUsername?" }', returns: "Bot invite + challenge" },
    { method: "POST", path: "/api/verify/website/initiate", desc: "Start website .well-known verification", body: '{ "profileId", "url|websiteUrl" }', returns: "challengeId + token + instructions" },
    { method: "POST", path: "/api/verify/website/verify", desc: "Confirm website ownership", body: '{ "challengeId", "method?" }', returns: "Verification result" },
    // === Reviews (V2) ===
