...
- Record the deployed mainnet escrow_v3 runtime identity as canonical runtime truth: program `HXCUWKR2NvRcZ7rNAJHwPcH6QAAWaLR4bRFbfyuDND6C`, ProgramData `Fg1DJyKX9CngiMihZxJY2zjaQ8T1PK5QuiVhNvJmeTqk`. The 2026-08-19T19:37:14Z upgrade transaction `3dKQibtuBon7f8dL9DSjsjCwLr1N9pw6pbgR1Kg69wTAnfwkA8RbKn4e7sqH39yhwwWEHkpWhhDxSG62DeBEsy1E` installed deployed binary `sha256=88058f4322bb8cbb9227b6f35ae3c78baf2be9c01a3bd70523f803f9bfa7f078` (346841 bytes after trimming 15 bytes of account padding); upgrade authority readback is `Bq1niVKyTECn4HDxAJWiHZvRMCZndZtC113yj3Rkbroc`. Deliverable PR #265, merged as `d197c8aceb7e4d523e5c5d96f157c23d677b01fd`, pins this exact allocated runtime payload for ongoing readback. This shipped marker certifies deployed-runtime identity only. [#49e40f78] [#3258f2a8] [#ef7e4581] [shipped]
- Re-certify source, build-input, and published-IDL provenance against the deployed `88058f43...` runtime. Deliverable PR #270 records the `2026-08-24T07:47:44.921Z` read-only runtime receipt and pins the source candidate, build inputs, toolchain, rebuilt artifact hash, and published IDL hash; its binding result is negative: the source-built binary does not equal the deployed runtime, and the published IDL does not equal the source IDL. Source == deployed == published IDL remains unproven; no redeploy is authorized by this roadmap correction. [#49e40f78] [#3258f2a8] [#ef7e4581] [pending]
...
- USDC escrow support remains pending: the repo source contains the SPL vault PDA / ATA / `transfer_checked` path and five USDC entrypoints (`create_usdc_escrow`, `release_usdc`, `partial_release_usdc`, `cancel_usdc`, `resolve_dispute_usdc`). The existing decoded IDL account `D2TVCWarEDQ3w3YFMpackzymm9MGQKeWd1p1pCeZmBcn` still contains only the prior 9 SOL instructions, but the 2026-08-19 mainnet upgrade replaced the binary without a matching validated IDL/provenance packet. Reconciliation verdict: neither “source-only” nor “deployed” is currently certified for [#806be0c8]; keep it pending until the replacement `88058f43...` binary is decoded and bound to an authoritative IDL and source. [#806be0c8] [pending]
