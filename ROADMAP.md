...
- Record the deployed mainnet escrow_v3 program as canonical runtime truth: program `HXCUWKR2NvRcZ7rNAJHwPcH6QAAWaLR4bRFbfyuDND6C`, ProgramData `Fg1DJyKX9CngiMihZxJY2zjaQ8T1PK5QuiVhNvJmeTqk`. The 2026-08-19T19:37:14Z upgrade transaction `3dKQibtuBon7f8dL9DSjsjCwLr1N9pw6pbgR1Kg69wTAnfwkA8RbKn4e7sqH39yhwwWEHkpWhhDxSG62DeBEsy1E` replaced the previously documented runtime with deployed binary `sha256=88058f4322bb8cbb9227b6f35ae3c78baf2be9c01a3bd70523f803f9bfa7f078` (346841 bytes after trimming 15 bytes of account padding); upgrade authority readback is `Bq1niVKyTECn4HDxAJWiHZvRMCZndZtC113yj3Rkbroc`. No source/toolchain/IDL packet currently binds to these replacement bytes: the prior `b70a7a7e...` archaeology is historical, and the existing uploaded IDL is stale relative to the upgraded binary. Re-certify source == deployed == IDL before restoring this marker; no redeploy is authorized by this roadmap correction. [#49e40f78] [#3258f2a8] [#ef7e4581] [pending]
