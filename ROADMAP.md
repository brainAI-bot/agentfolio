...
- Certify the AgentFolio escrow_v3 source as the canonical source-of-truth for mainnet HXCUWKR2 by reproducing `sha256(elf)=b70a7a7ea55f43da7bd3fc4f666e1374436bb9c8aeaa83cb2f0a2a970b603094` and verifying source == deployed mainnet program == IDL; devnet is not a satisfiable target because HXCUWKR2's devnet programData returns null/no deployed bytecode, and rebuilding the clawd-brainchain source would recreate the B1Se8SPx split-brain. [#49e40f78] [#3258f2a8] [blocked] · reproducible build byte match not yet certified
