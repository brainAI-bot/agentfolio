...
- Re-certify source, build-input, and published-IDL provenance against the current allocated `7672bd30...` / trimmed `85e71adf...` runtime. PR #273 and its `4f21da13...` build receipt are historical evidence for the superseded 2026-08-24 runtime, not the current deployment. No current source candidate, reproducible build packet, or source/published-IDL binding has yet been certified against the 2026-08-30 runtime; no redeploy or write action is authorized by this roadmap correction. [#49e40f78] [#3258f2a8] [#ef7e4581] [pending]
