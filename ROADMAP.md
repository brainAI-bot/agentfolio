...
- On-chain fee collection inside release/partial_release routes the platform percentage to the treasury (FriU1FEp…) — remains pending: neither live route has cross-host-auditable treasury-delta proof, and no audited source tree is certified against the deployed HXCU binary; current readback records AgentFolio-vs-audited-source divergence in docs/operational/ESCROW-V3-SOURCE-DEPLOYED-IDL-READBACK-49e40f78.md. [#011685d4] [pending]
