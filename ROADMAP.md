...
- Re-certify source, build-input, and published-IDL provenance against the deployed `88058f43...` runtime. No authoritative source/toolchain/build-input/published-IDL packet currently binds to these replacement bytes: the prior `b70a7a7e...` archaeology is historical, and the existing uploaded IDL is stale relative to the upgraded binary. Source == deployed == published IDL remains unproven; no redeploy is authorized by this roadmap correction. [#49e40f78] [#3258f2a8] [#ef7e4581] [pending]
