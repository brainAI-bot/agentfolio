...
- On-chain fee collection inside release/partial_release routes the platform percentage to the treasury (FriU1FEp…) — keep pending until GitHub/HQ-visible executed transfer evidence proves both live routes move the platform percentage to treasury and source/deployed/IDL alignment is certified; current cross-host readback records AgentFolio-vs-audited-source divergence in docs/operational/ESCROW-V3-SOURCE-DEPLOYED-IDL-READBACK-49e40f78.md. [#011685d4] [pending]
