...
- Authority-separation plan exists in docs/operational/ONCHAIN-ESCROW-AUTHORITY-SEPARATION-PLAN-2026-07-06.md: split deploy/upgrade authority from operational signers, naming the exact key roles for Owner provisioning (no key material in repo or HQ; fingerprints only). [#eb6ea3d2] [shipped]
