...
- On-chain fee collection inside release/partial_release routes the platform percentage to the treasury (FriU1FEp…) — today the 5% fee is computed in JSON and never moves; without this the take-rate is uncollectible. [#011685d4] [pending]
