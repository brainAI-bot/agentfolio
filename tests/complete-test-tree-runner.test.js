...
test('complete-tree discovery includes all eleven marketplace tests', () => {
  ...
  assert.deepEqual(marketplace, [
    ...
    'tests/marketplace-outcome-ledger.test.js',
    'tests/marketplace-prepush-acceptance.test.js',
