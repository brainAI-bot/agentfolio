...
async function generateCardBack(opts) {
  ...
  ctx.fillStyle = "rgba(255,45,120,0.15)"; ctx.fillText("BIRTH CERTIFICATE", W/2+2, 118);
  ctx.fillStyle = "rgba(20,241,149,0.15)"; ctx.fillText("BIRTH CERTIFICATE", W/2-2, 118);
  ctx.fillStyle = TEXT1; ctx.fillText("BIRTH CERTIFICATE", W/2, 118);
