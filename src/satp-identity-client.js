 ...
 * 
 * Observed mainnet layout (program BY4jz...):
 *   disc(8) + version(u64) + authority(Pubkey 32) + name(String) + description(String) +
 *   metadata_uri(String) + created_at(i64) + updated_at(i64) + reputation_score(u64) +
 *   verification_level(u8) + ... (pre-allocated zeros)
 */
