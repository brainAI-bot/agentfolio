...
That document is the sole hosting-options source for this decision. It includes the cheapest potentially compliant pilot, managed-database choices, process separation, S3 quarantine/artifact/evidence prefixes, five-minute RPO design, unmeasured-versus-achieved RTO reporting, isolation controls, and monthly line items.
